...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "BooksSummariesApp.Android.dll" comes first in this list. */
		"BooksSummariesApp.Android.dll",
		"BooksSummariesApp.Models.dll",
		"BooksSummariesApp.Infrastructure.dll",
		"Newtonsoft.Json.dll",
		"BooksSummariesApp.dll",
		"Couchbase.Lite.dll",
